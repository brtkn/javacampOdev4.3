...
public class TULExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(TULDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new TULStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static TULDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static TULDateTimeConverter dateTimeConverter = new TULStandardDateTimeConverter();

    public TULExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public TULExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new TULMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=TULHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,TULExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=TULHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
