...
public class TULKPSPublicSoap
{
    ...
    public TULKPSPublicSoap(){}

    public TULKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public TULKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        TULExtendedSoapSerializationEnvelope envelope= new TULExtendedSoapSerializationEnvelope(TULExtendedSoapSerializationEnvelope.VER11);
